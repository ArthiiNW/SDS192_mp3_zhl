...
Western_1117 <- db %>%
  dbGetQuery("SELECT info_type_id, movie_info.movie_id, info, keyword, aka_title.phonetic_code, production_year, title, keyword
 FROM imdb.aka_title
