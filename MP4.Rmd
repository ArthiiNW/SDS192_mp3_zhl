...
library(ggplot2)
library(scales)
Western_1117 <- read_csv("~/SDS192_MP4_zhl/Western_1120.csv")
```
...
library(ggplot2)
library(scales)
Superhero_1213 <- read_csv("~/SDS192_MP4_zhl/Superhero_1213.csv")
```
